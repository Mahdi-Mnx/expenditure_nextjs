        ...
        <div className="max-w-4xl mx-auto space-y-6 px-4 py-6">
          ...
          <div className="space-y-2">
            {[...Array(3)].map((_, i) => (
              <Skeleton
                key={i}
                className="h-12 w-full bg-slate-800 rounded-md"
              />
            ))}
          </div>

          {/* Security and Sign Out Skeleton */}
          <Skeleton className="h-12 w-full bg-slate-800 rounded-md" />
          <Skeleton className="h-12 w-full bg-red-500/30 rounded-md" />
        </div>
      </DashboardLayout>
    );
  }
